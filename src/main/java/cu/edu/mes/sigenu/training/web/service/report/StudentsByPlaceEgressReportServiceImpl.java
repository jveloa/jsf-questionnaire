...
public class StudentsByPlaceEgressReportServiceImpl implements StudentsByPlaceEgressReportService {
    ...
    @Override
    public List<String> getStudentsByPlaceEgress (Integer year, String idPlaceEgress, Integer questionnarieId){
        ...
        try {
            ...
            UriTemplate template = new UriTemplate("/api/v1/training/reportCareerChief/studentsByPlaceEgress/{year}/{idPlaceEgress}/{questionnarieId}");
