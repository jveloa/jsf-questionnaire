...
import cu.edu.mes.sigenu.training.web.config.ApplicationProperties;
...
public class RestService {
    ...
    public ResponseEntity DELETE(String endpoint, MultiValueMap<String,String> queryParams, Object body, Class clss, String jwt) {
        try {
            return buildRestTemplate().exchange(
            		getUri(getUrlBackend() + endpoint, queryParams),
                    HttpMethod.DELETE,
